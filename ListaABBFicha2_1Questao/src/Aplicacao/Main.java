...
public class Main {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case '2':
                    ...
                    entrada = in.nextInt();
                    System.out.println();
                    System.out.println("Resultado: "+ arvoreBB.buscarValor(entrada));
                    System.out.println();
                    break;
                case '3':
    ...
    public static void menu() {
        ...
        System.out.println("3 - quantidade de valor na arvore");
        System.out.println("4 - pecorrer em ordem");
        System.out.println("5 - pecorrer pre ordem");
